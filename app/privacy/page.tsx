  ...
  return (
    <div className="min-h-screen bg-dark-DEFAULT">
      <div className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-4xl font-medium text-paper mb-2">Privacy Policy</h1>
        <p className="text-paper text-sm mb-12">Last updated: March 2026</p>

        <div className="space-y-10 text-paper leading-relaxed">
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">1. Introduction</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">4. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">5. Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">6. Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">7. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">8. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-medium text-paper mb-3">9. Contact</h2>
            <p>
