      ...
      <section className="py-8 px-6 pb-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 p-8 rounded-2xl border border-accent/15 bg-accent/[0.03] text-center">
            ...
            <Link
              href="#"
              className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-sm font-medium bg-accent text-white hover:bg-accent-light transition-all duration-200 shadow-[0_0_16px_#8A4E2844]"
            >
              Join early access
            </Link>
          </div>
