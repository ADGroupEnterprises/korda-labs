  ...
  return (
    <div className="min-h-screen bg-paper">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <p className="text-ink text-sm mb-12">Last updated: March 2026</p>
        ...
        <div className="space-y-10 text-ink leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">2. Use of Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">3. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">5. Third-Party Integrations</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">6. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-ink mb-3">8. Termination</h2>
            <p>
