  ...
  return (
    <div className="min-h-screen bg-dark-DEFAULT">
      <div className="max-w-3xl mx-auto px-6 py-24">
        <h1 className="text-4xl font-bold text-paper mb-2">Terms of Service</h1>
        <p className="text-paper text-sm mb-12">Last updated: March 2026</p>

        <div className="space-y-10 text-paper leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">2. Use of Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">3. Accounts</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">5. Third-Party Integrations</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">6. Disclaimers</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">7. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">8. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">9. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-paper mb-3">10. Contact</h2>
            <p>
