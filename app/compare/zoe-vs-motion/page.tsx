        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-16">
            <div className="p-6 rounded-2xl border border-ink/10 bg-ink/[0.03]">
              <p className="text-xs font-medium tracking-widest uppercase text-accent mb-3">Motion</p>
      ...
      <section className="py-4 px-6 pb-24">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-3 gap-4 mb-4 px-4">
            ...
            <div className="text-xs font-medium tracking-widest uppercase text-accent text-center">Motion</div>
