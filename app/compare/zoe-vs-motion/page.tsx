        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-16">
            <div className="p-6 rounded-2xl border border-paper-100 bg-paper-100">
              <p className="text-[0.9rem] font-bold tracking-widest uppercase text-accent mb-3">Motion</p>
      ...
      <section className="py-4 px-6 pb-24">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-3 gap-4 mb-4 px-4">
            ...
            <div className="text-[0.9rem] font-bold tracking-widest uppercase text-accent text-center">Motion</div>
          ...
          <div className="rounded-2xl border border-paper-100 overflow-hidden">
            {rows.map((row, i) => (
              ...
              >
                ...
                <div className="text-sm text-ink text-center">{row.motion}</div>
