  ...
  return (
    <section className="relative py-40 px-6 overflow-hidden" ref={ref}>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div>
            <p className="text-accent text-[0.9rem] font-bold tracking-[0.16em] uppercase mb-4">What agents can do</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          {capabilities.map((cap, i) => (
            <motion.div
              ...
              className="flex gap-4 p-5 rounded-2xl border border-linen bg-linen hover:border-linen hover:bg-linen transition-colors duration-300"
            >
              <div className="flex-shrink-0 w-9 h-9 rounded-xl bg-linen flex items-center justify-center text-ink">
                {cap.icon}
              </div>
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-8 border-t border-linen"
        >
