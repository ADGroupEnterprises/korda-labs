...
function FeatureCard({ feature, index }: { feature: typeof features[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 rounded-2xl border border-mahogany bg-ink hover:border-mahogany hover:bg-ink transition-all duration-300"
    >
      {/* Hover glow */}
...
export default function Features() {
  ...
  return (
    <section id="features" className="relative py-32 px-6">
      {/* Section divider */}
      <div className="absolute top-0 left-0 right-0 h-px bg-mahogany" />
