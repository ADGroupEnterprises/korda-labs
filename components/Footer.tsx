...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-ink/8 py-12 px-6" ref={ref}>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-semibold text-ink/80 tracking-wide">Korda Labs</span>
            <p className="text-ink/35 text-xs">KORDA LABS</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 text-sm text-ink/40">
          ...
          <a href="#" className="hover:text-ink/60 transition-colors">Contact</a>
        </div>
