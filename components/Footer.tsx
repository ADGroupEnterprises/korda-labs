...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-linen pt-16 pb-10 px-6" ref={ref}>
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10 mb-16">
          ...
          {/* Product */}
          <div>
            <p className="text-xs font-medium tracking-widest uppercase text-ink mb-4">Product</p>
            <ul className="space-y-3">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-ink hover:text-ink transition-colors">{l.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* How it Works */}
          <div>
            <p className="text-xs font-medium tracking-widest uppercase text-ink mb-4">How it Works</p>
            <ul className="space-y-3">
              {[
          ...
          {/* Compare */}
          <div>
            <p className="text-xs font-medium tracking-widest uppercase text-ink mb-4">Compare</p>
            <ul className="space-y-3">
              {[
          ...
          {/* Company */}
          <div>
            <p className="text-xs font-medium tracking-widest uppercase text-ink mb-4">Company</p>
            <ul className="space-y-3">
              {[
