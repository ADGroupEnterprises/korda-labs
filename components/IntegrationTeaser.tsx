        ...
        >
          {integrations.map((name, i) => (
            <motion.span
              ...
              className="px-4 py-2 rounded-full border border-linen bg-linen text-ink text-sm hover:border-linen hover:text-ink hover:bg-linen transition-all duration-300 cursor-default"
            >
              {name}
            </motion.span>
          ))}
          <motion.span
            ...
            className="px-4 py-2 rounded-full border border-mahogany bg-mahogany text-paper text-sm"
          >
            + more every week
          </motion.span>
        </motion.div>
